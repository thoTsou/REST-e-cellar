<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	if(altName.contains("_")){
		webResource = client.resource("http://localhost:8080/RESTfullCellarAPI/rest/CellarService/addSpirit/"+altName+"/"+color+"/"+price+"/"+origin+"/"+alcohol+"/"+category+"/"+quantityAdded);
	}else{
		webResource = client.resource("http://localhost:8080/RESTfullCellarAPI/rest/CellarService/addSpirit/"+name+"/"+color+"/"+price+"/"+origin+"/"+alcohol+"/"+category+"/"+quantityAdded);
	}
